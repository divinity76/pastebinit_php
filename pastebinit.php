...
function paste_fedoraproject(string $topaste): string {
	...
	$data = json_encode ( $data, JSON_NUMERIC_CHECK | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PARTIAL_OUTPUT_ON_ERROR | JSON_PRESERVE_ZERO_FRACTION | JSON_UNESCAPED_LINE_TERMINATORS );
	$hc = new hhb_curl ();
